...
<body>
    ...
    <div id="sendEmail">
        <table>
            ...
            <tr>
                <td >
                    Account:<input v-model = "Account" placeholder = "Accout">
                </td>
                <td>
            ...
            <tr>
                <td colspan = 4>
                    Subject:<input v-model = "Subject"  placeholder = "Subject"  style='width:90%'>
                </td>
                
            </tr>
            <tr>
                <td colspan = 4>
                    Body:<input v-model = "Body"  placeholder = "Body" style='width:90%'>
                </td>
            </tr>
            <tr>
                <td colspan = 4>
                <button id ="sendEmail" type="button" @click="sendEmail">Send Email</button>
                <span v-html = 'sendEmailState'></span>
                </td>
    ...
    <script>
        ...
        var send=new Vue({
            ...
            data:{
                ...
                Account:'',
                Password:'',
                Subject:"SDMxxx Weekxx-xx RadarMap",
                Body:"Hello , this is the score of your SDMxxx  week xx-xx, please check it. Please download the attachment and open it with your browser.",
                sendEmailState:'',
                courseList:<?php echo json_encode($_SESSION['courseList'])?>
            },
            methods:{
                sendEmail:function(){
                    ...
                    this.sendEmailState="Sending,please wait for a moment";
                    var that=this;
                    for (var pair of params.entries()) {
                        console.log(pair[0] + ', ' + pair[1]);
                    }
                    axios.post('sendemail.php',params).then(function(response){
                        console.log(response.data);
                        that.sendEmailState = "Done";
                    });
                }
                }
